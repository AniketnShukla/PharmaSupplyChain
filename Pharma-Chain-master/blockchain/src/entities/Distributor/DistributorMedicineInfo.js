...
export default function DistributorMedicineInfo(props) {
    ...
    function getSupplyChainSteps() {
        return ['At Manufacturer', 'Collected by Transporter', 'Delivered to Wholesaler', 'Collected by Transporter', 'Delivered to Distributor', 
    ...
    async function saveMedicineDetails() {
        ...
        //Save details from here to Customer
        alert(medicineAddress)
        alert(web3.utils.hexToUtf8(data[1]))
        // // axios.post('http://localhost:3500/api/medicine/save-details', {
        ...
        // }).then((response) => {
        //     alert(response.data);
        //     // axios.post('http://localhost:3500/api/transaction/save-details', {
        //     axios.post('http://localhost:3500/', {
        //         'medicineAddress': medicineAddress,
        ...
        // axios.post('http://localhost:3500/api/medicine/save-details', {
            alert(pricePerUnit)
        axios.post('http://localhost:3500/meds', {
            'medicineAddress': medicineAddress,
            'description': web3.utils.hexToUtf8(data[1]),
            'price': pricePerUnit,
            'quantity': Number(data[3]),
