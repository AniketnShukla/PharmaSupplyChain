...
contract SupplyChain {
    ...
    function respondToManufacturer(address buyer, address seller, address packageAddr, bytes calldata signature) external {
    ...
    function requestRawMaterial(address supplierAddr, address manuAddr, address rawMaterialAddr, bytes calldata signature) external {
